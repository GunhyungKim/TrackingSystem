...
// ==== Invoke Thermal ====
// peer chaincode invoke -o orderer0.example.com:7050 -C $CHANNEL_NAME -n thermal -c '{"Args":["initThermal","Name","PN","location","time","temperature"]}'
...
func (t *SimpleChaincode) Invoke(stub shim.ChaincodeStubInterface) pb.Response {
	...
	} else if function == "queryThermalByName" {
		return t.queryThermal(stub, args)
...
func (t *SimpleChaincode) initThermal(stub shim.ChaincodeStubInterface, args []string) pb.Response {
	...
	rawlc := args[2]
	rawt := args[3]
	rawbt, err := strconv.ParseFloat(args[4], 64)
	if err != nil {
	...
	err = stub.PutState(args[1]+rawlc, thermalJSONasBytes)
	if err != nil {
		return shim.Error(err.Error())
	}
...
func (t *SimpleChaincode) queryThermalByName(stub shim.ChaincodeStubInterface, args []string) pb.Response {
